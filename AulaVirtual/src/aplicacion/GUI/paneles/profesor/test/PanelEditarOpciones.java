...
private static final long serialVersionUID = 1L;
	...
	public PanelEditarOpciones (Opcion opc, PreguntaOpcion p, Test t) {
		...
		cancelar.addActionListener(new ActionCancelarEditarOpc(p, t));
		JButton aceptar = new JButton ("Aceptar");
		aceptar.addActionListener(new ActionAceptarEditarOpc(this, opc, p, t));
